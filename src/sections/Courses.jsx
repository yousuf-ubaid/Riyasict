...
const courses = [
  {
    ...
    description:
      'Advanced Level (O/L) ICT introduces students to the fundamentals of Information and Communication Technology, covering computer systems, programming, databases, networking, web development, information systems, and emerging technologies. It develops logical thinking, technical skills, and prepares students for higher education and careers in the IT field.',
    highlights: [
      'Complete Full Theory Coverage',
      'Past Paper Discussions & Exam Practice',
      'Live Score Board & Progress Tracking',
      'Class Playbacks Available Until Exam',
      'Educational Events & Special Programs',
      'Lab Practicals & Hands-on Training',
    ],
  ...
  },
  {
    ...
    description:
      'Ordinary Level (O/L) ICT introduces students to the basic concepts of Information and Communication Technology, including computer fundamentals, software applications, internet usage, basic programming concepts, databases, and digital communication. It helps students develop essential computer skills, logical thinking, and prepares them for advanced studies in ICT and everyday digital life.',
    highlights: [
      'Model Paper Tests & Mock Exams',
      'Individual Student Progress Monitoring',
      'Exam Tips, Short Notes & Revision Packs',
      'Programming & SQL Practice Sessions',
      'Doubt Clearing Sessions (Q&A Support)',
      'Monthly Revision & Final Crash Sessions',
    ],
